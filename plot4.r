...
plot(dt1$Voltage, type = "l", xlab = "datatime", ylab = "Voltage", xaxt = "n")
axis(side = 1, at = c(0, 1440, 2880), labels = c("Thu","Fri","Sat"))
...
axis(side = 1, at = c(0, 1440, 2880), labels = c("Thu","Fri","Sat"))
legend("topright", legend=c("sub_metering_1", "sub_metering_2", "sub_metering_3"), lty = 1, col = c("purple", "red", "blue"), box.lty = 0)

# Create the fourth plot

plot(dt1$Global_reactive_power, type = "l", xlab = "datatime", ylab = "Global_Reactive_Power", xaxt = "n")
axis(side = 1, at = c(0, 1440, 2880), labels = c("Thu","Fri","Sat"))
